...
on_time = today_sunset - td
#print(type(today_sunset.hour))
with open("sunset_time.txt", 'w') as file:
    file.write(f'{on_time.hour}'.zfill(2) + ":" + f'{on_time.minute}'.zfill(2))
...
" + f'{on_time.minute}' + " " + f'{on_time.hour}' + " * * * sudo killall python ; sudo /usr/bin/python /home/peter/LED_CODE/WS2812LED_PythonCode/slow_change.py\n\
